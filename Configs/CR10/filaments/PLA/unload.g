M291 P"Espera a que la boquilla alcance la temperatura" R"Descargando PLA" T5 ; Display message
G10 S200 ; Heat up the current tool to 200C
M116 ; Wait for the temperatures to be reached
M291 P"Retrayendo filamento..." R"Descargando PLA" T5 ; Display another message
